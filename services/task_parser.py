...
def _system_prompt(guruhlar_matni: str, bugun: str, ertaga: str, bugun_kuni: str) -> str:
    return (
        ...
        f"Ertaga: {ertaga}\n\n"
        "Qoidalar:\n"
        "- Guruhni nomi bo'yicha topib, uning id sini yoz. Nom aniq mos "
        "kelmasa ham, ma'nosi bo'yicha eng yaqinini tanla.\n"
        "- Qaysi guruh nazarda tutilgani umuman tushunarsiz bo'lsa yoki "
        "mos guruh topilmasa, tushunarli=false qilib, savol maydonida "
        "o'zbekcha aniq savol yoz.\n"
